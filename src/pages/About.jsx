...
const About = () => {
    return (
        <div className=" bg-gray-900 text-white py-12 px-8 flex flex-col gap-8">
            <GlobeDemo />
    ...
    return (
        <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto  bg-gray-900 relative w-full">
            <div className=" mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
                ...
                <div className="absolute w-full bottom-0 inset-x-0 h-40 bg-gradient-to-b pointer-events-none select-none from-transparent  to-[#212121] z-40" />
